...
export default function ChatBoxApp() {
  ...
  const sendMessenger = () => {
    ...
    // Auto reply
    setTimeout(() => {
      const reply = { id: (Date.now() + 1).toString(), text: "Okay! ", sender: "bot" };
    ...
    >
      <View style={styles.centerWrapper}>
        ...
        <View style={styles.cardNews}>
          <Text style={styles.title}>Insta Feed</Text>
          <Text style={styles.subtitle}> Lovers Rock/girl in red</Text>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: "#c3c7f4", // full background
  },
  centerWrapper: {
    flex: 1,
